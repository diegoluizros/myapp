  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Dados do planeta foram ${widget.isIncluir ? 'incluido' : 'alterado'} com sucesso!',
          ),
        ),
      );
              ...
              children: [
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty || value.length < 3) {
                      return 'Por favor, imforme o nome do planeta (3 ou mais caracteres)';
                    }
                    return null;
                  },
                  onSaved: (value) {
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if (double.tryParse(value) == null) {
                      return 'Por favor, informe um número válido para a distância';
                    }
                    return null;
                  },
                  onSaved: (value) {
